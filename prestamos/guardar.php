...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($tabla == 'daniel') {
        $sql = "INSERT INTO transacciones_daniel (fecha, razon, cantidad) VALUES ('$fecha', '$razon', '$cantidad')";
    } elseif ($tabla == 'mildred') {
        $sql = "INSERT INTO transacciones_mildred (fecha, razon, cantidad) VALUES ('$fecha', '$razon', '$cantidad')";
    } else {
