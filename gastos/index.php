...
$sql_daniel = "SELECT * FROM transacciones_daniel1";
$result_daniel = $conn->query($sql_daniel);

// Obtener la suma total de las cantidades de Daniel
$sql_suma_daniel = "SELECT SUM(cantidad) AS total_cantidad FROM transacciones_daniel1";
...
$sql_mildred = "SELECT * FROM transacciones_mildred2";
$result_mildred = $conn->query($sql_mildred);

// Obtener la suma total de las cantidades de Mildred
$sql_suma_mildred = "SELECT SUM(cantidad) AS total_cantidad FROM transacciones_mildred2";
  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php">Gastos</a>
        </li>       
      </ul>
    </div>
  </div>
</nav>
 <h1><center>GASTOS</center></h1>
    <div class="container">
        <div class="row">
